...
public class BlasLapackGenerator {
  ...
  private static Set<String> methodsToSkip =
      new HashSet<>(
          Arrays.asList(
              "LAPACK_zlangb_base",
              "LAPACK_lsame_base",
  ...
  public static void main(String... args) throws Exception {
    BlasLapackGenerator blasLapackGenerator =
        new BlasLapackGenerator(
            new File("../../nd4j/nd4j-backends/nd4j-api-parent/nd4j-api/src/main/java/"));
    blasLapackGenerator.parse();
    String generated =
        FileUtils.readFileToString(blasLapackGenerator.getTargetFile(), Charset.defaultCharset());
