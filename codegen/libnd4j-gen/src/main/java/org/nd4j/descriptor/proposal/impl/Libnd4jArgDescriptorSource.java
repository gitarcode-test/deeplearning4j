...
public class Libnd4jArgDescriptorSource implements ArgDescriptorSource {
  ...
  public static final String OP_IMPL = "OP_IMPL";
  public static final String DIVERGENT_OP_IMPL = "DIVERGENT_OP_IMPL";
  public static final String CONFIGURABLE_OP_IMPL = "CONFIGURABLE_OP_IMPL";
  public static final String REDUCTION_OP_IMPL = "REDUCTION_OP_IMPL";
  public static final String BROADCASTABLE_OP_IMPL = "BROADCASTABLE_OP_IMPL";
  public static final String BROADCASTABLE_BOOL_OP_IMPL = "BROADCASTABLE_BOOL_OP_IMPL";
  public static final String PLATFORM_IMPL = "PLATFORM_IMPL";
  public static final String PLATFORM_CHECK = "PLATFORM_CHECK";
  public static final String PLATFORM_TRANSFORM_STRICT_IMPL = "PLATFORM_TRANSFORM_STRICT_IMPL";
  public static final String RETURN = "return";
  public static final String INT_ARG = "INT_ARG";
  public static final String I_ARG = "I_ARG";
  public static final String INPUT_VARIABLE = "INPUT_VARIABLE";
  public static final String OUTPUT_VARIABLE = "OUTPUT_VARIABLE";
  public static final String OUTPUT_NULLIFIED = "OUTPUT_NULLIFIED";
  public static final String INPUT_LIST = "INPUT_LIST";
  public static final String T_ARG = "T_ARG";
  public static final String B_ARG = "B_ARG";
  public static final String DECLARE_SYN = "DECLARE_SYN";
  public static final String DEFAULT_LIBND4J_DIRECTORY = "../../libnd4j";
  public static final int BROADCASTABLE_OP_IMPL_DEFAULT_NIN = 2;
  public static final int BROADCASTABLE_OP_IMPL_DEFAULT_NOUT = 1;
  public static final String CUSTOM_OP_IMPL = "CUSTOM_OP_IMPL";
  public static final String BOOLEAN_OP_IMPL = "BOOLEAN_OP_IMPL";
  public static final String LIST_OP_IMPL = "LIST_OP_IMPL";
  public static final String LOGIC_OP_IMPL = "LOGIC_OP_IMPL";

  public static final String PLATFORM_SCALAR_OP_IMPL = "PLATFORM_SCALAR_OP_IMPL";

  // note this allows either a declaration like: auto variableNum = SOME_DECLARATION(0); or auto
  // variableNum = SOME_DECLARATION(0) == 1;
  public static final String ARG_DECLARATION = "(\\w+\\s)+\\w+\\s*=\\s*[A-Z]+_[A-Z]+\\(\\d+\\);";
  public static final String ARG_BOOL_EQUALS_DECLARATION =
      "(\\w+\\s)+\\w+\\s*=\\s*[A-Z]+_[A-Z]+\\(\\d+\\)\\s*==\\s*\\d+;";
  public static final String ARG_DECLARATION_WITH_VARIABLE =
      "(\\w+\\s)+\\w+\\s*=\\s*[A-Z]+_[A-Z]+\\([\\d\\w\\+-*\\/]+);";
  public static final String ARRAY_ASSIGNMENT =
      "\\w+\\[[\\w\\d]\\]\\s*=\\s*[A-Z]+_[A-Z]+\\s*\\([\\w\\d\\+\\-\\*\\/\\s]+\\);";

  @Getter private Map<String, OpNamespace.OpDescriptor.OpDeclarationType> opTypes = new HashMap<>();

  private Set<String> unencounteredAliasKeys = new HashSet<>();

  @Builder
  public Libnd4jArgDescriptorSource(String libnd4jPath, double weight) {
    if (libnd4jPath == null) libnd4jPath = "../libnd4j";
  ...
  public Map<String, List<ArgDescriptorProposal>> doExtractArgDescriptors() {
    ...
    Files.walk(
            new File(libnd4jRootDir, "include/ops").toPath(),
        ...
        .forEach(
            path -> {
              try {
                ...
                OpDeclarationDescriptor.OpDeclarationDescriptorBuilder builder =
                    OpDeclarationDescriptor.builder();
                int currentOpNin = -1,
                    currentOpNout = -1,
                    currentOpIntArgs = -1,
                    currentOutTArgs = -1,
                ...
                for (String line : lines) {
                  ...
                  if (!inOpBlock) {
                    if (line.contains(CUSTOM_OP_IMPL) && !line.contains("ENGINE")) {
                      ...
                      if (name.equals("range")) {
                        List<ArgDescriptorProposal> finalArgDescriptorProposals =
                            argDescriptorProposals;
                        Arrays.asList(
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.CUSTOM_OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.BOOLEAN_OP_IMPL)
                          .nIn(nIn)
                          .inplaceAble(inplaceAble);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(OpDeclarationDescriptor.OpDeclarationType.LIST_OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                          .iArgs(iArgs)
                          .tArgs(tArgs);
                      ...
                      if (name.equals("gather_list")
                          || name.equals("stack_list")
                          || name.equals("split_list")) {
                        // importDataType
                        argDescriptorProposals.add(
                            ArgDescriptorProposal.builder()
                                .sourceOfProposal("cpp")
                      ...
                      // LOGIC_OP_IMPL(NAME)
                      foundOp = true;
                      if (line.contains(");")) oneLineOp = true;
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.LOGIC_OP_IMPL);

                      inOpBlock = true;
                      // dummy output for import
                      if (name.equals("While")
                          || name.equals("Switch") | name.equals("Conditional")) {
                        argDescriptorProposals.add(
                            ArgDescriptorProposal.builder()
                                .proposalWeight(9999.0)
                                .descriptor(
                      ...
                      name = split[0];
                      opTypes.put(
                          name, OpNamespace.OpDescriptor.OpDeclarationType.DIVERGENT_OP_IMPL);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.DIVERGENT_OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                          .inplaceAble(inplaceAble);
                      ...
                      name = split[0];
                      opTypes.put(
                          name, OpNamespace.OpDescriptor.OpDeclarationType.CONFIGURABLE_OP_IMPL);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.CONFIGURABLE_OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                          .inplaceAble(inplaceAble)
                          .iArgs(iArgs)
                      ...
                      name = split[0];
                      opTypes.put(
                          name, OpNamespace.OpDescriptor.OpDeclarationType.REDUCTION_OP_IMPL);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.REDUCTION_OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                          .inplaceAble(inplaceAble)
                          .iArgs(iArgs)
                      ...
                      name = split[0];
                      opTypes.put(
                          name, OpNamespace.OpDescriptor.OpDeclarationType.BROADCASTABLE_OP_IMPL);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.BROADCASTABLE_OP_IMPL)
                      ...
                      opTypes.put(
                          name,
                          OpNamespace.OpDescriptor.OpDeclarationType.BROADCASTABLE_BOOL_OP_IMPL);
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.BROADCASTABLE_BOOL_OP_IMPL)
                          .nIn(BROADCASTABLE_OP_IMPL_DEFAULT_NIN)
                          .nOut(BROADCASTABLE_OP_IMPL_DEFAULT_NOUT)
                          .iArgs(iArgs)
                          .tArgs(tArgs);
                      ...
                      String[] split = line.trim().split(",");
                      name = split[0];
                      // sometimes ops can appear more than once per platform, only keep original
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(
                              OpDeclarationDescriptor.OpDeclarationType.PLATFORM_IMPL);
                      inOpBlock = true;
                      hasNin = true;
                      hasNout = true;
                      platformImpl = true;
                      ...
                      builder
                          .name(name)
                          .opDeclarationType(OpDeclarationDescriptor.OpDeclarationType.OP_IMPL)
                          .nIn(nIn)
                          .nOut(nOut)
                          .inplaceAble(inplaceAble);
                      ...
                      || line.contains(PLATFORM_SCALAR_OP_IMPL)
                      || line.contains(
                          PLATFORM_CHECK)) { // platform ops are no ops since all platform ops have
                  ...
                  if (inOpBlock && line.contains(RETURN) && endOfBlock(currLineIdx, lines)
                      || oneLineOp) {
                  ...
                  if (inOpBlock) {
                    if (argDescriptorProposals == null) argDescriptorProposals = new ArrayList<>();
                    if (line.isEmpty()) {
                      // ignore
                    ...
                    if (matchesArgDeclaration(INT_ARG, line)) {
                      processLine(
                          ...
                          OpNamespace.ArgDescriptor.ArgType.INT64,
                          name);
                      // hard coded case, impossible to parse from as the code exists today, and it
                      // doesn't exist anywhere in the libnd4j code base
                      if (name.contains("maxpool2d")) {
                        if (!containsProposalWithDescriptorName(
                            "extraParam0", argDescriptorProposals)) {
                          argDescriptorProposals.add(
                              ArgDescriptorProposal.builder()
                    ...
                    if (!line.contains("->rankOf()")
                            && !line.contains("->dataType()")
                            && matchesArgDeclaration(INPUT_VARIABLE, line)
                        || matchesArgDeclaration(INPUT_LIST, line)) {
                      processLine(
                          inArgNames,
                          inArgIndices,
                          argDescriptorProposals,
                  ...
                  if (line.contains(DECLARE_SYN)) {
                    ...
                    if (!descriptorMap.containsKey(aliasFor)) {
                      ...
                      OpDeclarationDescriptor.OpDeclarationDescriptorBuilder opDescriptor2 =
                          descriptorMap.get(aliasFor).toBuilder();
  ...
  private void processArrayLine(
      List<String> iArgNames,
      List<Integer> iArgIndices,
    ...
    ArgDescriptorParserUtils.addArrayNameToList(
        line, iArgNames, iArgIndices, argDeclarationForType(argType));
    ...
    OpNamespace.ArgDescriptor argDescriptor =
        OpNamespace.ArgDescriptor.newBuilder()
            ...
            .setIsArray(true)
            .setConvertBoolToInt(
                argType == OpNamespace.ArgDescriptor.ArgType.BOOL || line.contains("B_ARG"))
            .setName(name)
            .setArgIndex(-1)
            .build();

    double weightToIncrementBy = weight * 1000000;
    ArgDescriptorProposal argDescriptorProposal =
        ArgDescriptorProposal.builder()
  ...
  private void processLine(
      ...
      OpNamespace.ArgDescriptor.ArgType argType,
      String opName) {
    boolean matchesPureDeclaration =
        Pattern.matches(ARG_DECLARATION, line)
            || Pattern.matches(ARG_BOOL_EQUALS_DECLARATION, line)
            || Pattern.matches(ARRAY_ASSIGNMENT, line);
    ...
    ArgDescriptorParserUtils.addNameToList(
        line, iArgNames, iArgIndices, argDeclarationForType(argType));
    // note sometimes we have individual array entries for names, we need to strip out index
    // indicators like [i]
    ...
    // remove duplicate proposals and only take the max index ensuring all parameters are accounted
    // for
    val groupedByName =
        argDescriptorProposals.stream()
            .collect(Collectors.groupingBy(proposal -> proposal.getDescriptor().getName()));
