...
public class UpdateDecoder {
  ...
  public static class MemoryUseDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='memoryType', description='null', id=101, version=0,
      // encodedLength=0, offset=0, componentTokenCount=10, encoding=Encoding{presence=REQUIRED,
      ...
      // semanticType='null'}}
      // Token{signal=BEGIN_ENUM, name='MemoryType', description='null', id=-1, version=0,
      // encodedLength=1, offset=0, componentTokenCount=8, encoding=Encoding{presence=REQUIRED,
      ...
      builder.append(memoryType());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='memoryBytes', description='null', id=102, version=0,
      // encodedLength=0, offset=1, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
      // offset=1, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
  ...
  public static class PerformanceDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='totalRuntimeMs', description='null', id=201, version=0,
      ...
      builder.append(totalRuntimeMs());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='totalExamples', description='null', id=202, version=0,
      // encodedLength=0, offset=8, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
      // offset=8, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("totalExamples=");
      builder.append(totalExamples());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='totalMinibatches', description='null', id=203, version=0,
      // encodedLength=0, offset=16, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
      // offset=16, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("totalMinibatches=");
      builder.append(totalMinibatches());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='examplesPerSecond', description='null', id=204, version=0,
      // encodedLength=0, offset=24, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='float', description='null', id=-1, version=0, encodedLength=4,
      // offset=24, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=FLOAT,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("examplesPerSecond=");
      builder.append(examplesPerSecond());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='minibatchesPerSecond', description='null', id=205,
      // version=0, encodedLength=0, offset=28, componentTokenCount=3,
      ...
      // Token{signal=ENCODING, name='float', description='null', id=-1, version=0, encodedLength=4,
      // offset=28, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=FLOAT,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
  ...
  public static class GcStatsDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='deltaGCCount', description='null', id=301, version=0,
      // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
      // offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("deltaGCCount=");
      builder.append(deltaGCCount());
      builder.append('|');
      // Token{signal=BEGIN_FIELD, name='deltaGCTimeMs', description='null', id=302, version=0,
      // encodedLength=0, offset=4, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
      // offset=4, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("deltaGCTimeMs=");
      builder.append(deltaGCTimeMs());
      builder.append('|');
      // Token{signal=BEGIN_VAR_DATA, name='gcName', description='null', id=1000, version=0,
      // encodedLength=0, offset=8, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
  ...
  public static class ParamNamesDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_VAR_DATA, name='paramName', description='null', id=1100, version=0,
  ...
  public static class LayerNamesDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_VAR_DATA, name='layerName', description='null', id=1101, version=0,
      // encodedLength=0, offset=0, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
  ...
  public static class PerParameterStatsDecoder
    ...
    public static class SummaryStatDecoder
      ...
      public StringBuilder appendTo(final StringBuilder builder) {
        builder.append('(');
        // Token{signal=BEGIN_FIELD, name='statType', description='null', id=403, version=0,
        // encodedLength=0, offset=0, componentTokenCount=8, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=BEGIN_ENUM, name='StatsType', description='null', id=-1, version=0,
        // encodedLength=1, offset=0, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
        // primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
        // semanticType='null'}}
        builder.append("statType=");
        builder.append(statType());
        builder.append('|');
        // Token{signal=BEGIN_FIELD, name='summaryType', description='null', id=404, version=0,
        // encodedLength=0, offset=1, componentTokenCount=7, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=BEGIN_ENUM, name='SummaryType', description='null', id=-1, version=0,
        // encodedLength=1, offset=1, componentTokenCount=5, encoding=Encoding{presence=REQUIRED,
        // primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
        // semanticType='null'}}
        ...
        builder.append(summaryType());
        builder.append('|');
        // Token{signal=BEGIN_FIELD, name='value', description='null', id=405, version=0,
        // encodedLength=0, offset=2, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=ENCODING, name='double', description='null', id=-1, version=0,
        // encodedLength=8, offset=2, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
        // primitiveType=DOUBLE, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
    ...
    public static class HistogramsDecoder
      ...
      public static class HistogramCountsDecoder
        ...
        public StringBuilder appendTo(final StringBuilder builder) {
          builder.append('(');
          // Token{signal=BEGIN_FIELD, name='binCount', description='null', id=412, version=0,
          // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
          // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
          // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
          // timeUnit=nanosecond, semanticType='null'}}
          // Token{signal=ENCODING, name='uint32', description='null', id=-1, version=0,
          // encodedLength=4, offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
          // primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
          // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
          // timeUnit=nanosecond, semanticType='null'}}
      ...
      public StringBuilder appendTo(final StringBuilder builder) {
        builder.append('(');
        // Token{signal=BEGIN_FIELD, name='statType', description='null', id=407, version=0,
        // encodedLength=0, offset=0, componentTokenCount=8, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        ...
        builder.append(statType());
        builder.append('|');
        // Token{signal=BEGIN_FIELD, name='minValue', description='null', id=408, version=0,
        // encodedLength=0, offset=1, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=ENCODING, name='double', description='null', id=-1, version=0,
        // encodedLength=8, offset=1, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
        // primitiveType=DOUBLE, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        ...
        builder.append(minValue());
        builder.append('|');
        // Token{signal=BEGIN_FIELD, name='maxValue', description='null', id=409, version=0,
        // encodedLength=0, offset=9, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=ENCODING, name='double', description='null', id=-1, version=0,
        // encodedLength=8, offset=9, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
        // primitiveType=DOUBLE, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        ...
        builder.append(maxValue());
        builder.append('|');
        // Token{signal=BEGIN_FIELD, name='nBins', description='null', id=410, version=0,
        // encodedLength=0, offset=17, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0,
        // encodedLength=4, offset=17, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
        // primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        builder.append("nBins=");
        builder.append(nBins());
        builder.append('|');
        // Token{signal=BEGIN_GROUP, name='histogramCounts', description='null', id=411, version=0,
        // encodedLength=4, offset=21, componentTokenCount=9, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
        // semanticType='null'}}
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='learningRate', description='null', id=401, version=0,
      // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='float', description='null', id=-1, version=0, encodedLength=4,
      // offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=FLOAT,
      // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
      // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
      builder.append("learningRate=");
      builder.append(learningRate());
      builder.append('|');
      // Token{signal=BEGIN_GROUP, name='summaryStat', description='null', id=402, version=0,
      // encodedLength=10, offset=4, componentTokenCount=24, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
      // semanticType='null'}}
      ...
      builder.append(']');
      builder.append('|');
      // Token{signal=BEGIN_GROUP, name='histograms', description='null', id=406, version=0,
      // encodedLength=21, offset=-1, componentTokenCount=32, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
      // semanticType='null'}}
  ...
  private final DataSetMetaDataBytesDecoder dataSetMetaDataBytes =
      new DataSetMetaDataBytesDecoder();
  ...
  public static class DataSetMetaDataBytesDecoder
      implements Iterable<DataSetMetaDataBytesDecoder>,
          java.util.Iterator<DataSetMetaDataBytesDecoder> {
    private static final int HEADER_SIZE = 4;
    private final GroupSizeEncodingDecoder dimensions = new GroupSizeEncodingDecoder();
    private UpdateDecoder parentMessage;
    private DirectBuffer buffer;
    ...
    public static class MetaDataBytesDecoder
      ...
      public StringBuilder appendTo(final StringBuilder builder) {
        builder.append('(');
        // Token{signal=BEGIN_FIELD, name='bytes', description='null', id=502, version=0,
        // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
        // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
        // Token{signal=ENCODING, name='int8', description='null', id=-1, version=0,
        // encodedLength=1, offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED,
        // primitiveType=INT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null,
        // nullValue=null, constValue=null, characterEncoding='null', epoch='unix',
        // timeUnit=nanosecond, semanticType='null'}}
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_GROUP, name='metaDataBytes', description='null', id=501, version=0,
      // encodedLength=1, offset=0, componentTokenCount=9, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
      // semanticType='null'}}
  ...
  public int getDataSetMetaDataClassName(
  ...
  public StringBuilder appendTo(final StringBuilder builder) {
    ...
    builder.append(time());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='deltaTime', description='null', id=2, version=0,
    // encodedLength=0, offset=8, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
    // offset=8, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("deltaTime=");
    builder.append(deltaTime());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='iterationCount', description='null', id=3, version=0,
    // encodedLength=0, offset=12, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
    // offset=12, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("iterationCount=");
    builder.append(iterationCount());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='fieldsPresent', description='null', id=4, version=0,
    // encodedLength=0, offset=16, componentTokenCount=26, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=BEGIN_SET, name='UpdateFieldsPresent', description='null', id=-1, version=0,
    // encodedLength=4, offset=16, componentTokenCount=24, encoding=Encoding{presence=REQUIRED,
    // primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
    // semanticType='UpdateFieldsPresent'}}
    builder.append("fieldsPresent=");
    builder.append(fieldsPresent());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='statsCollectionDuration', description='null', id=5,
    // version=0, encodedLength=0, offset=20, componentTokenCount=3,
    // encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN,
    // minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null',
    // epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
    // offset=20, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    ...
    // offset=24, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    // Token{signal=ENCODING, name='double', description='null', id=-1, version=0, encodedLength=8,
    // offset=24, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=DOUBLE,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("score=");
    builder.append(score());
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='memoryUse', description='null', id=100, version=0,
    // encodedLength=9, offset=32, componentTokenCount=19, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='performance', description='null', id=200, version=0,
    // encodedLength=32, offset=-1, componentTokenCount=21, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='gcStats', description='null', id=300, version=0,
    // encodedLength=8, offset=-1, componentTokenCount=18, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='paramNames', description='null', id=350, version=0,
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='layerNames', description='null', id=351, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=12, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='perParameterStats', description='null', id=400, version=0,
    // encodedLength=4, offset=-1, componentTokenCount=65, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='dataSetMetaDataBytes', description='null', id=500, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=15, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='sessionID', description='null', id=1200, version=0,
    ...
    builder.append(sessionID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='typeID', description='null', id=1201, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(typeID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='workerID', description='null', id=1202, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(workerID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='dataSetMetaDataClassName', description='null', id=1300,
