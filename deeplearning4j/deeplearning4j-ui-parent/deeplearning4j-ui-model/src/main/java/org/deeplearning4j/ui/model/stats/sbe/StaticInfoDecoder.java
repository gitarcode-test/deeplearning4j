...
public class StaticInfoDecoder {
  ...
  public static class HwDeviceInfoGroupDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='deviceMemoryMax', description='null', id=10, version=0,
      // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
      // offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
      ...
      builder.append(deviceMemoryMax());
      builder.append('|');
      // Token{signal=BEGIN_VAR_DATA, name='deviceDescription', description='null', id=50,
      // version=0, encodedLength=0, offset=8, componentTokenCount=6,
  ...
  public static class SwEnvironmentInfoDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_VAR_DATA, name='envKey', description='null', id=51, version=0,
      // encodedLength=0, offset=0, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
      ...
      builder.append(envKey());
      builder.append('|');
      // Token{signal=BEGIN_VAR_DATA, name='envValue', description='null', id=52, version=0,
      // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
  ...
  public static class ModelParamNamesDecoder
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_VAR_DATA, name='modelParamNames', description='null', id=53, version=0,
      // encodedLength=0, offset=0, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
      // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
      // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
      // semanticType='null'}}
  ...
  public int getSwJvmSpecVersion(
      final MutableDirectBuffer dst, final int dstOffset, final int length) {
    final int headerLength = 4;
    final int limit = parentMessage.limit();
    final int dataLength =
  ...
  public int getSwNd4jBackendClass(
      final MutableDirectBuffer dst, final int dstOffset, final int length) {
    final int headerLength = 4;
    final int limit = parentMessage.limit();
    final int dataLength =
  ...
  public int getSwNd4jDataTypeName(
      final MutableDirectBuffer dst, final int dstOffset, final int length) {
    final int headerLength = 4;
    final int limit = parentMessage.limit();
    final int dataLength =
  ...
  public int getModelConfigClassName(
      final MutableDirectBuffer dst, final int dstOffset, final int length) {
    final int headerLength = 4;
    final int limit = parentMessage.limit();
    final int dataLength =
  ...
  public StringBuilder appendTo(final StringBuilder builder) {
    ...
    // offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
    // offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
    ...
    builder.append(time());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='fieldsPresent', description='null', id=2, version=0,
    // encodedLength=0, offset=8, componentTokenCount=7, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=BEGIN_SET, name='InitFieldsPresent', description='null', id=-1, version=0,
    // encodedLength=1, offset=8, componentTokenCount=5, encoding=Encoding{presence=REQUIRED,
    // primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null,
    // semanticType='FieldsPresent'}}
    builder.append("fieldsPresent=");
    builder.append(fieldsPresent());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='hwJvmProcessors', description='null', id=3, version=0,
    // encodedLength=0, offset=9, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='uint16', description='null', id=-1, version=0, encodedLength=2,
    // offset=9, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT16,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("hwJvmProcessors=");
    builder.append(hwJvmProcessors());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='hwNumDevices', description='null', id=4, version=0,
    // encodedLength=0, offset=11, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='uint8', description='null', id=-1, version=0, encodedLength=1,
    // offset=11, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("hwNumDevices=");
    builder.append(hwNumDevices());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='hwJvmMaxMemory', description='null', id=5, version=0,
    // encodedLength=0, offset=12, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
    // offset=12, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("hwJvmMaxMemory=");
    builder.append(hwJvmMaxMemory());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='hwOffheapMaxMemory', description='null', id=6, version=0,
    // encodedLength=0, offset=20, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
    // offset=20, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("hwOffheapMaxMemory=");
    builder.append(hwOffheapMaxMemory());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='modelNumLayers', description='null', id=7, version=0,
    // encodedLength=0, offset=28, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int32', description='null', id=-1, version=0, encodedLength=4,
    // offset=28, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT32,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("modelNumLayers=");
    builder.append(modelNumLayers());
    builder.append('|');
    // Token{signal=BEGIN_FIELD, name='modelNumParams', description='null', id=8, version=0,
    // encodedLength=0, offset=32, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    // Token{signal=ENCODING, name='int64', description='null', id=-1, version=0, encodedLength=8,
    // offset=32, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT64,
    // byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null,
    // characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    builder.append("modelNumParams=");
    builder.append(modelNumParams());
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='hwDeviceInfoGroup', description='null', id=9, version=0,
    // encodedLength=8, offset=40, componentTokenCount=15, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='swEnvironmentInfo', description='null', id=12, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=18, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='modelParamNames', description='null', id=11, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=12, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
    builder.append("modelParamNames=[");
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='sessionID', description='null', id=100, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(sessionID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='typeID', description='null', id=101, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(typeID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='workerID', description='null', id=102, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(workerID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swArch', description='null', id=201, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swArch());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swOsName', description='null', id=202, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swOsName());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swJvmName', description='null', id=203, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swJvmName());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swJvmVersion', description='null', id=204, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swJvmVersion());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swJvmSpecVersion', description='null', id=205, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swJvmSpecVersion());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swNd4jBackendClass', description='null', id=206,
    // version=0, encodedLength=0, offset=-1, componentTokenCount=6,
    // encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN,
    // minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null',
    // epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    ...
    builder.append(swNd4jBackendClass());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swNd4jDataTypeName', description='null', id=207,
    // version=0, encodedLength=0, offset=-1, componentTokenCount=6,
    // encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN,
    // minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null',
    // epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    ...
    builder.append(swNd4jDataTypeName());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swHostName', description='null', id=208, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swHostName());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='swJvmUID', description='null', id=209, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(swJvmUID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='hwHardwareUID', description='null', id=300, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(hwHardwareUID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='modelConfigClassName', description='null', id=400,
    // version=0, encodedLength=0, offset=-1, componentTokenCount=6,
    // encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN,
    // minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null',
    // epoch='unix', timeUnit=nanosecond, semanticType='null'}}
    ...
    builder.append(modelConfigClassName());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='modelConfigJson', description='null', id=401, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
