...
public class StorageMetaDataDecoder {
  ...
  public StorageMetaDataDecoder wrap(
  ...
  public static class ExtraMetaDataBytesDecoder
      implements Iterable<ExtraMetaDataBytesDecoder>,
          java.util.Iterator<ExtraMetaDataBytesDecoder> {
    ...
    public StringBuilder appendTo(final StringBuilder builder) {
      builder.append('(');
      // Token{signal=BEGIN_FIELD, name='bytes', description='null', id=3, version=0,
      ...
      // semanticType='null'}}
      // Token{signal=ENCODING, name='int8', description='null', id=-1, version=0, encodedLength=1,
      // offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=INT8,
  ...
  public StringBuilder appendTo(final StringBuilder builder) {
    ...
    builder.append("):");
    // Token{signal=BEGIN_FIELD, name='timeStamp', description='null', id=1, version=0,
    // encodedLength=0, offset=0, componentTokenCount=3, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(timeStamp());
    builder.append('|');
    // Token{signal=BEGIN_GROUP, name='extraMetaDataBytes', description='Extra metadata bytes',
    // id=2, version=0, encodedLength=1, offset=8, componentTokenCount=9,
    ...
    // epoch='null', timeUnit=null, semanticType='null'}}
    ...
    builder.append(']');
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='sessionID', description='null', id=4, version=0,
    ...
    builder.append(sessionID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='typeID', description='null', id=5, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(typeID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='workerID', description='null', id=6, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(workerID());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='initTypeClass', description='null', id=7, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
    ...
    builder.append(initTypeClass());
    builder.append('|');
    // Token{signal=BEGIN_VAR_DATA, name='updateTypeClass', description='null', id=8, version=0,
    // encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED,
    // primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null,
    // constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond,
    // semanticType='null'}}
