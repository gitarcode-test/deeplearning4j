...
public class EmnistDataFetcher extends MnistDataFetcher implements DataSetFetcher {
  ...
  public EmnistDataFetcher(
    ...
    // For some inexplicable reason, EMNIST LETTERS set is indexed 1 to 26 (i.e., 1 to nClasses),
  ...
  public EmnistDataFetcher(
      EMnistSet dataSet, boolean binarize, boolean train, boolean shuffle, long rngSeed)
      throws IOException {
    this(
        dataSet,
        binarize,
