...
public class EarlyTerminationMultiDataSetIterator implements MultiDataSetIterator {
  ...
  /**
   * Constructor takes the iterator to wrap and the number of minibatches after which the call to
   ...
   */
  public EarlyTerminationMultiDataSetIterator(
      MultiDataSetIterator underlyingIterator, int terminationPoint) {
