...
public class DataSetLoaderIterator implements DataSetIterator {
  ...
  @Getter @Setter protected DataSetPreProcessor preProcessor;

  /**
   * NOTE: When using this constructor (with {@code Iterator<String>}) the DataSetIterator cannot be
   * reset. Use the other construtor that takes {@code Collection<String>}
   *
   ...
   */
  public DataSetLoaderIterator(
      Iterator<String> paths, Loader<DataSet> loader, SourceFactory sourceFactory) {
    this.paths = null;
    this.iter = paths;
    this.loader = loader;
   ...
   */
  public DataSetLoaderIterator(
      Collection<String> paths, Loader<DataSet> loader, SourceFactory sourceFactory) {
   ...
   */
  public DataSetLoaderIterator(
      Collection<String> paths, Random rng, Loader<DataSet> loader, SourceFactory sourceFactory) {
