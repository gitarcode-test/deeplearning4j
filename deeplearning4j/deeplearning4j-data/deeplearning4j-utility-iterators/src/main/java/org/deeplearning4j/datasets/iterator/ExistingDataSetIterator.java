...
public class ExistingDataSetIterator implements DataSetIterator {
  ...
  public ExistingDataSetIterator(
      @NonNull Iterator<DataSet> iterator, @NonNull List<String> labels) {
    this(iterator);
    this.labels = labels;
  }
   ...
   */
  public ExistingDataSetIterator(
      @NonNull Iterable<DataSet> iterable, @NonNull List<String> labels) {
    this(iterable);
    this.labels = labels;
  }

  public ExistingDataSetIterator(
      @NonNull Iterable<DataSet> iterable, int totalExamples, int numFeatures, int numLabels) {
    this(iterable);
  ...
  public int totalOutcomes() {
    if (labels != null) return labels.size();
  ...
  @Override
  public void reset() {
    if (iterable != null) this.iterator = iterable.iterator();
    else
