...
public class SerializingListener<T extends SequenceElement> implements VectorsListener<T> {
  ...
  /**
   * This method is called prior each processEvent call, to check if this specific VectorsListener
   * implementation is viable for specific event
   *
   * @param event
   * @param argument
  ...
  public static class Builder<T extends SequenceElement> {
    ...
    /**
     * This method allows you to define template for file names that will be created during
     * serialization
     *
     * @param reallyUse
     * @return
