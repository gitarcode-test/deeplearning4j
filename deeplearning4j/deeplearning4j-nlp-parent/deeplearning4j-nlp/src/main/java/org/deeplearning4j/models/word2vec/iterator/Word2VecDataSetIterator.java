...
public class Word2VecDataSetIterator implements DataSetIterator {
   ...
   */
  public Word2VecDataSetIterator(
      Word2Vec vec,
   ...
   */
  public Word2VecDataSetIterator(
      Word2Vec vec, LabelAwareSentenceIterator iter, List<String> labels) {
   ...
   */
  public Word2VecDataSetIterator(
      Word2Vec vec, LabelAwareSentenceIterator iter, List<String> labels, int batch) {
  ...
  public DataSet next(int num) {
    ...
    // need the next sentence
      ...
      while (cachedWindow.size() < num && iter.hasNext()) {
        ...
        List<Window> windows =
            Windows.windows(sentence, vec.getTokenizerFactory(), vec.getWindow(), vec);
