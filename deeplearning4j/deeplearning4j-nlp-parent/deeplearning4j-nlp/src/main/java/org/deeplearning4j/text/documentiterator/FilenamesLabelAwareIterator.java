...
public class FilenamesLabelAwareIterator implements LabelAwareIterator {
  ...
  */
  ...
  public static class Builder {
    ...
    /**
     * Root folder for labels -> documents. Each subfolder name will be presented as label, and
     * contents of this folder will be represented as LabelledDocument, with label attached
     *
