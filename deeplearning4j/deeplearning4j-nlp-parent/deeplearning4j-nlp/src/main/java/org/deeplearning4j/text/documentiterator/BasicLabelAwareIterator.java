...
public class BasicLabelAwareIterator implements LabelAwareIterator {
  ...
  public static class Builder {
    ...
    /**
     * We assume that each sentence in this iterator is separate document/paragraph. Labels will be
     * converted into LabelledDocument format
     *
     * @param iterator
     */
    ...
    /**
     * We assume that each inputStream in this iterator is separate document/paragraph Labels will
     * be converted into LabelledDocument format
     *
     * @param iterator
     */
    ...
    /**
     * Label template will be used for sentence labels generation. I.e. if provided template is
     * "DOCUMENT_", all documents/paragraphs will have their labels starting from "DOCUMENT_0" to
     * "DOCUMENT_X", where X is the total number of documents - 1
     *
     * @param template
     * @return
     */
