...
public class VocabWord extends SequenceElement implements Serializable {
  ...
  */
  ...
  public VocabWord(double wordFrequency, @NonNull String word) {
    if (word.isEmpty()) throw new IllegalArgumentException("Word must not be null or empty");
    this.word = word;
  ...
  public int hashCode() {
    final int result =
        this.word == null ? 0 : this.word.hashCode(); // this.elementFrequency.hashCode();
    return result;
  }
