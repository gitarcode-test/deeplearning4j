...
public class PopularityWalker<T extends SequenceElement> extends RandomWalker<T>
        ...
        case FORWARD_PREFERRED:
          {
            ...
            PriorityQueue<Node<T>> queue =
                new PriorityQueue<>(Math.max(10, connections.length), new NodeComparator());
            ...
            if (connections.length > 0) {
              ...
              for (int connected : connections) {
                Node<T> tNode =
                    new Node<>(connected, sourceGraph.getConnectedVertices(connected).size());
                queue.add(tNode);
              }
              ...
              // logger.info("Spread: ["+ cSpread+ "], Connections: ["+ connections.length+"],
  ...
  public static class Builder<T extends SequenceElement> extends RandomWalker.Builder<T> {
    ...
    /**
     * This method defines which nodes should be taken in account when choosing next hope: maximum
     * popularity, lowest popularity, or average popularity. Default value: MAXIMUM
     *
    ...
    /**
     * This method defines, how much nodes should take place in next hop selection. Something like
     * top-N nodes, or bottom-N nodes. Default value: 10
     *
     * @param topN
     * @return
     */
    ...
    /**
     * This method allows you to define, if nodes within popularity spread should have equal chances
     * to be picked for next hop, or they should have chances proportional to their popularity.
     *
     * <p>Default value: PLAIN
     *
     * @param spectrum
     * @return
     */
