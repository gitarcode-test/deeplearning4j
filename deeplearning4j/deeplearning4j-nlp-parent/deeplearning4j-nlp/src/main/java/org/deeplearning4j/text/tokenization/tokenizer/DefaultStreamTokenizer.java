...
public class DefaultStreamTokenizer implements Tokenizer {
  ...
  /**
   * Returns number of tokens PLEASE NOTE: this method effectively preloads all tokens. So use it
   * with caution, since on large streams it will consume big amount of memory
   *
   * @return
   */
  @Override
