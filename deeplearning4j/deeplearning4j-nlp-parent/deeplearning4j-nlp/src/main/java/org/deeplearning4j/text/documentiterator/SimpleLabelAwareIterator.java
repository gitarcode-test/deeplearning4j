...
public class SimpleLabelAwareIterator implements LabelAwareIterator {
  ...
  /**
   * Builds LabelAwareIterator instance using Iterator object PLEASE NOTE: If instance is built
   * using Iterator object, reset() method becomes unavailable
   *
   * @param iterator
   */
  ...
  @Override
  public void reset() {
    if (underlyingIterable != null) this.currentIterator = this.underlyingIterable.iterator();
    else
      throw new UnsupportedOperationException(
          "You can't use reset() method for Iterator<> based instance, please provide Iterable<>"
              + " instead, or avoid reset()");
  }
