...
public class Convolution1DUtils {
   ...
   * Convolution1DLayer}, {@link Subsampling1DLayer} {@link SimpleRnn} {@link LSTM} {@link
  ...
  public static RNNFormat getRnnFormatFromLayer(Layer layer) {
    ...
    if (layer instanceof SimpleRnn) {
      ...
      throw new IllegalArgumentException(
          "Illegal layer type " + layer.getClass().getName() + " and name " + layer.getLayerName());
    }
  }
  ...
  public static long getOutputSize(
      ...
      int dilation) {
    return getOutputSizeLong(
        inH, (long) kernel, (long) strides, (long) padding, convolutionMode, (long) dilation);
  }
