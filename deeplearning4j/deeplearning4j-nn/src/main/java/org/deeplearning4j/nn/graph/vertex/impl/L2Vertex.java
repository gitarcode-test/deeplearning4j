...
public class L2Vertex extends BaseGraphVertex {
  ...
  public L2Vertex(
      ComputationGraph graph, String name, int vertexIndex, double eps, DataType dataType) {
  ...
  public Pair<Gradient, INDArray[]> doBackward(boolean tbptt, LayerWorkspaceMgr workspaceMgr) {
    ...
    return new Pair<>(
        null,
        new INDArray[] {
          workspaceMgr.leverageTo(ArrayType.ACTIVATION_GRAD, dLda),
          workspaceMgr.leverageTo(ArrayType.ACTIVATION_GRAD, dLdb)
        });
  }
