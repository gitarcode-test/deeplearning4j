...
public class Yolo2OutputLayer extends org.deeplearning4j.nn.conf.layers.Layer {
  ...
  public static class Builder extends org.deeplearning4j.nn.conf.layers.Layer.Builder<Builder> {
    ...
    /**
     * Loss function for the class predictions - defaults to L2 loss (i.e., sum of squared errors,
     * as per the paper), however Loss MCXENT could also be used (which is more common for
     * classification).
     */
     ...
     * example, a network with 13x13 output, a value of 1.0 would correspond to one grid cell; a
     * value of 13 would correspond to the entire image.
     */
    private INDArray boundingBoxes;
     ...
     * classification).
     *
     * @param lossClassPredictions Loss function for the class prediction error component of the
     *     YOLO loss function
     */
