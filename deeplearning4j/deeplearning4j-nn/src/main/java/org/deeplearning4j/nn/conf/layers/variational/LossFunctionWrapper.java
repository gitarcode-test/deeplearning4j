...
public class LossFunctionWrapper implements ReconstructionDistribution {
  ...
  public LossFunctionWrapper(
      @JsonProperty("activationFn") IActivation activationFn,
  ...
  public double negLogProbability(INDArray x, INDArray preOutDistributionParams, boolean average) {
    ...
    // NOTE: The returned value here is NOT negative log probability, but it (the loss function
    // value)
