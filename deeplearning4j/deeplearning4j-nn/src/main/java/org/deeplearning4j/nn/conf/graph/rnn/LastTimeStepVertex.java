...
public class LastTimeStepVertex extends GraphVertex {
  ...
  /**
   * @param maskArrayInputName The name of the input to look at when determining the last time step.
   *     Specifically, the mask array of this time series input is used when determining which time
   *     step to extract and return.
   */
  ...
  @Override
  public org.deeplearning4j.nn.graph.vertex.impl.rnn.LastTimeStepVertex instantiate(
    ...
    return new org.deeplearning4j.nn.graph.vertex.impl.rnn.LastTimeStepVertex(
  ...
  public InputType getOutputType(int layerIndex, InputType... vertexInputs)
    ...
    if (vertexInputs.length != 1)
      throw new InvalidInputTypeException(
          "Invalid input type: cannot get last time step of more than 1 input");
  ...
  public MemoryReport getMemoryReport(InputType... inputTypes) {
    ...
    return new LayerMemoryReport.Builder(
            null, LastTimeStepVertex.class, inputTypes[0], getOutputType(-1, inputTypes))
        .standardMemory(0, 0)
