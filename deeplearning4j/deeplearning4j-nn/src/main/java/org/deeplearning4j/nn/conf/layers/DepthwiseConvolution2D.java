...
public class DepthwiseConvolution2D extends ConvolutionLayer {
  ...
  protected DepthwiseConvolution2D(Builder builder) {
    ...
    Preconditions.checkState(
        builder.depthMultiplier > 0,
        "Depth multiplier must be > 0,  got %s",
        builder.depthMultiplier);
  ...
  public static class Builder extends BaseConvBuilder<Builder> {
    ...
    public void setKernelSize(long... kernelSize) {
      this.kernelSize = ValidationUtils.validate2NonNegativeLong(kernelSize, false, "kernelSize");
    }

    @Override
    public void setStride(long... stride) {
      this.stride = ValidationUtils.validate2NonNegativeLong(stride, false, "stride");
    }
