...
public class LocalResponseNormalization extends Layer {
  ...
  // Set defaults here as well as in builder, in case users use no-arg constructor instead of
  // builder
  ...
  public InputType getOutputType(int layerIndex, InputType inputType) {
    if (inputType == null || inputType.getType() != InputType.Type.CNN) {
      throw new IllegalStateException(
          "Invalid input type for LRN layer (layer index = "
              + layerIndex
              + ", layer name = \""
              + getLayerName()
              + "\"): Expected input of type CNN, got "
              + inputType);
    }
    return inputType;
  }
  ...
  public void setNIn(InputType inputType, boolean override) {
    Preconditions.checkState(
        ...
        "Only CNN input types can be used with LocalResponseNormalisation, got %s",
        inputType);
  ...
  public static class Builder extends Layer.Builder<Builder> {
     ...
     * to the user. If false, the built-in (non-CuDNN) implementation for BatchNormalization will be
     * used
     */
    protected boolean cudnnAllowFallback = true;
     ...
     * When using CuDNN and an error is encountered, should fallback to the non-CuDNN
     * implementatation be allowed? If set to false, an exception in CuDNN will be propagated back
     * to the user. If true, the built-in (non-CuDNN) implementation for BatchNormalization will be
     * used
     *
     ...
     * back to the user. If true, the built-in (non-MKL/CuDNN) implementation for
     * LocalResponseNormalizationLayer will be used
     *
     * @param allowFallback Whether fallback to non-CuDNN implementation should be used
     */
