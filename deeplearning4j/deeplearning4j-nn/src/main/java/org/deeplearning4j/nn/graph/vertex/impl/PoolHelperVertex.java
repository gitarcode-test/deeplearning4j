...
public class PoolHelperVertex extends BaseGraphVertex {
  ...
  public Pair<INDArray, MaskState> feedForwardMaskArrays(
    ...
    // Which means: if any masks are missing, output null (equivalent to no mask, or all steps
    // present)
