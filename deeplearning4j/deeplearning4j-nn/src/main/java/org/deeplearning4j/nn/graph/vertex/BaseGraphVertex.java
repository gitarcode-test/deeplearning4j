...
public abstract class BaseGraphVertex implements GraphVertex {
   ...
   * inputVertices[X].getVertexEdgeNumber() = Z then the Zth output of vertex Y is the Xth input to
   * this vertex
   */
   ...
   * Specifically, if outputVertices[X].getVertexIndex() = Y, and
   * outputVertices[X].getVertexEdgeNumber() = Z then the output of this vertex (there is only one
   * output) is connected to the Zth input of vertex Y
   */
  ...
  @Setter @Getter protected boolean outputVertex;

  protected DataType dataType;

  protected BaseGraphVertex(
   ...
   * A representation of the vertices that this vertex is connected to (outputs duing forward pass)
   * Specifically, if outputVertices[X].getVertexIndex() = Y, and
   * outputVertices[X].getVertexEdgeNumber() = Z then the Xth output of this vertex is connected to
   * the Zth input of vertex Y
   */
  @Override
