...
public class Deconvolution2D extends ConvolutionLayer {
  ...
  public Layer instantiate(
    ...
    LayerValidation.assertNInNOutSet(
        "Deconvolution2D", getLayerName(), layerIndex, getNIn(), getNOut());

    Deconvolution2DLayer ret = new Deconvolution2DLayer(conf, networkDataType);
  ...
  public InputType getOutputType(int layerIndex, InputType inputType) {
    ...
    return InputTypeUtil.getOutputTypeDeconvLayerLong(
        inputType,
        kernelSize,
        stride,
        padding,
