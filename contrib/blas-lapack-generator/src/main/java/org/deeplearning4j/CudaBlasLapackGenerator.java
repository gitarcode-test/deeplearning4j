...
public class CudaBlasLapackGenerator {
  ...
  public static void main(String... args) throws Exception {
    CudaBlasLapackGenerator cudaBlasLapackGenerator =
        new CudaBlasLapackGenerator(
            new File("../../nd4j/nd4j-backends/nd4j-backend-impls/nd4j-cuda/src/main/java"));
    cudaBlasLapackGenerator.parse();
    String generated =
        FileUtils.readFileToString(
            cudaBlasLapackGenerator.getTargetFile(), Charset.defaultCharset());
