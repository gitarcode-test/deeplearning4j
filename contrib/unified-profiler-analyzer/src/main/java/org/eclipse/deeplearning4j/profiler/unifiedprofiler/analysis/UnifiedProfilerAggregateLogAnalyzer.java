...
public class UnifiedProfilerAggregateLogAnalyzer extends Application {
  ...
  DateTimeFormatter formatter =
      DateTimeFormatter.ofPattern("EEE MMM dd HH:mm:ss zzz", Locale.ENGLISH);
  ...
  public void analyze() throws Exception {
    ...
    timeAxis.setTickLabelFormatter(
    ...
    TransformProcessRecordReader transformProcessRecordReader =
        new TransformProcessRecordReader(arrowRecordReader, transformProcess);
    ...
    render(
        runtimeSeries.getRuntimeMaxMemory(),
        timeAxis,
        "Java heap max memory",
        new File("runtime-max-memory.png"));
    render(
        runtimeSeries.getJavacppAvailablePhysicalBytes(),
        timeAxis,
        "Javacpp available physical bytes",
        new File("javacpp-max-physical-bytes.png"));
    render(
        runtimeSeries.getJavacppMaxBytes(),
        timeAxis,
        "Javacpp maxphysical bytes",
        new File("javacpp-max-bytes.png"));
    render(
        runtimeSeries.getJavacppAvailablePhysicalBytes(),
        timeAxis,
        "Javacpp available physical bytes",
        new File("javacpp-available-physical-bytes.png"));
    render(
        runtimeSeries.getRuntimeFreeMemory(),
        timeAxis,
        "Java heap free memory",
        new File("runtime-free-memory.png"));
  }

  private void render(
      XYChart.Series<Number, Number> series, NumberAxis timeChart, String label, File outputFile)
      throws IOException {
  ...
  public void start(Stage stage) throws Exception {
    UnifiedProfilerAggregateLogAnalyzer unifiedProfilerLogAnalyzer =
        new UnifiedProfilerAggregateLogAnalyzer(inputFile, stage);
