...
/**
 * This extension disables any tests for gpu that are large resources or long. GPU tests should only
 * need to test execution on the gpu.
 *
 * @author Adam Gibson
 */
public class BackendCheckerExtension implements ExecutionCondition {

  public static final Set<String> invalidResourcesTags =
      new HashSet<>() {
        {
