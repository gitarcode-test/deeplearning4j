 ...
 * @author Max Pumperla
 */
@DisplayName("Keras Alpha Dropout Test")
@Tag(TagNames.FILE_IO)
@Tag(TagNames.KERAS)
@NativeTag
class KerasAlphaDropoutTest extends BaseDL4JTest {
    ...
    @Test
    @DisplayName("Test Alpha Dropout Layer")
    void testAlphaDropoutLayer() throws Exception {
