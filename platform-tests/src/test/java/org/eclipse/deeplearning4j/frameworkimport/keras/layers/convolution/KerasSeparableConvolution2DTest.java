 ...
 * @author Max Pumperla
 */
@DisplayName("Keras Separable Convolution 2 D Test")
@Tag(TagNames.FILE_IO)
@Tag(TagNames.KERAS)
@NativeTag
class KerasSeparableConvolution2DTest extends BaseDL4JTest {
    ...
    @Test
    @DisplayName("Test Separable Convolution 2 D Layer")
    void testSeparableConvolution2DLayer() throws Exception {
    ...
    private void buildSeparableConvolution2DLayer(KerasLayerConfiguration conf, Integer kerasVersion, boolean withDilation) throws Exception {
