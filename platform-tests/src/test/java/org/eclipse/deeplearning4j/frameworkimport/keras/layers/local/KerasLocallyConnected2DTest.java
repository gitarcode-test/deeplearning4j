 ...
 * @author Max Pumperla
 */
@DisplayName("Keras Locally Connected 2 D Test")
@Tag(TagNames.FILE_IO)
@Tag(TagNames.KERAS)
@NativeTag
class KerasLocallyConnected2DTest extends BaseDL4JTest {
    ...
    @Test
    @DisplayName("Test Locally Connected 2 D Layer")
    void testLocallyConnected2DLayer() throws Exception {
        buildLocallyConnected2DLayer(conf1, keras1);
        buildLocallyConnected2DLayer(conf2, keras2);
    }

    private void buildLocallyConnected2DLayer(KerasLayerConfiguration conf, Integer kerasVersion) throws Exception {
