...
public class TADTests extends BaseNd4jTestWithBackends {
  ...
  public void testEquality1(Nd4jBackend backend) {
    ...
    List<long[]> dim_3 =
        Arrays.asList(
            new long[] {0, 2, 3}, new long[] {0, 1, 2}, new long[] {1, 2, 3}, new long[] {0, 1, 3});
  ...
  public void testMysteriousCrash(Nd4jBackend backend) {
    ...
    //        log.info("Got TADShapeF: {}", Arrays.toString(tadBuffersF.getFirst().asInt()) + " with
    // java "
    //                        + javaFTad.shapeInfoDataBuffer());
    //        log.info("Got TADShapeC: {}", Arrays.toString(tadBuffersC.getFirst().asInt()) + " with
    // java "
