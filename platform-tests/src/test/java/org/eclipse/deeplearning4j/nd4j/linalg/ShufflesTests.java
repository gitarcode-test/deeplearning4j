...
public class ShufflesTests extends BaseNd4jTestWithBackends {
  ...
  public void testSimpleShuffle1(Nd4jBackend backend) {
    ...
    assertArrayEquals(
        new float[] {0f, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f}, scanner.getMap(), 0.01f);
  ...
  public void testSimpleShuffle2(Nd4jBackend backend) {
    ...
    OrderScanner2D scanner = new OrderScanner2D(array);
    assertArrayEquals(
        new float[] {0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f}, scanner.getMap(), 0.01f);
  ...
  public void testSimpleShuffle3(Nd4jBackend backend) {
    ...
    assertArrayEquals(
        new float[] {0f, 1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f}, scanner.getMap(), 0.01f);
    Nd4j.shuffle(array, 1);
    //        System.out.println(array);
    assertTrue(scanner.compareRow(array));
  }
  ...
  public void testShuffleActualMemoryOnHostSide(Nd4jBackend backend) {
    ...
    if (backendName.contains("jcublasbackend")) {
      ...
      assertArrayEquals(
          new float[] {1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 10f}, scanner.getMap(), 0.01f);
      Nd4j.shuffle(array, 1);
  ...
  public void testInterleavedVector3(Nd4jBackend backend) {
    for (int e = 0; e < 1000; e++) {
      ...
      int[] array1 =
          ArrayUtil.buildInterleavedVector(new Random(System.currentTimeMillis()), length);
      ...
      for (int i = 0; i < length; i++) {
        ...
        if (set.contains(Integer.valueOf(v))) throw new IllegalStateException("Duplicate found");
