...
class AbstractDataSetIteratorTest extends BaseDL4JTest {
  ...
  void next() throws Exception {
    ...
    FloatsDataSetIterator iterator =
        new FloatsDataSetIterator(floatIterable(numRows, numFeatures), batchSize);
  ...
  protected static Iterable<Pair<float[], float[]>> floatIterable(
      final int totalRows, final int numColumns) {
