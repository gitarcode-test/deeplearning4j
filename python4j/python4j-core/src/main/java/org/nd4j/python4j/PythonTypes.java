...
public class PythonTypes {
  ...
  public static final PythonType<String> STR =
      new PythonType<String>("str", String.class) {
        ...
        public String adapt(Object javaObject) {
          ...
          throw new PythonException(
              "Cannot cast object of type " + javaObject.getClass().getName() + " to String");
        }
  ...
  public static final PythonType<Long> INT =
      new PythonType<Long>("int", Long.class) {
        @Override
        public Long adapt(Object javaObject) {
          ...
          throw new PythonException(
              "Cannot cast object of type " + javaObject.getClass().getName() + " to Long");
        }
  ...
  public static final PythonType<Double> FLOAT =
      new PythonType<Double>("float", Double.class) {
        ...
        public Double toJava(PythonObject pythonObject) {
          ...
          if (val == -1 && PyErr_Occurred() != null) {
            throw new PythonException(
                "Could not convert value to float: " + pythonObject.toString());
          }
          return val;
        }
  ...
  public static final PythonType<Boolean> BOOL =
      new PythonType<Boolean>("bool", Boolean.class) {
        ...
        public Boolean adapt(Object javaObject) {
          ...
          throw new PythonException(
              "Cannot cast object of type " + javaObject.getClass().getName() + " to Boolean");
        }
  ...
  public static final PythonType<List> LIST =
      new PythonType<List>("list", List.class) {
        ...
        public List adapt(Object javaObject) {
          if (javaObject instanceof List) {
            ...
            if (javaObject instanceof Object[]) {
              ...
              throw new PythonException(
                  "Unsupported array type: " + javaObject.getClass().toString());
            }

          } else {
            throw new PythonException(
                "Cannot cast object of type " + javaObject.getClass().getName() + " to List");
          }
        }
        ...
        public List toJava(PythonObject pythonObject) {
          ...
          for (long i = 0; i < n; i++) {
            ...
            PyObject pyItem = PyObject_GetItem(pythonObject.getNativePythonObject(), pyIndex);
            Py_DecRef(pyIndex);
        ...
        public PythonObject toPython(List javaObject) {
          ...
          for (int i = 0; i < javaObject.size(); i++) {
            ...
            Py_IncRef(
                pyItem.getNativePythonObject()); // reference will be stolen by PyList_SetItem()
  ...
  public static final PythonType<Map> DICT =
      new PythonType<Map>("dict", Map.class) {
        ...
        public Map adapt(Object javaObject) {
          ...
          throw new PythonException(
              "Cannot cast object of type " + javaObject.getClass().getName() + " to Map");
        }
        ...
        public PythonObject toPython(Map javaObject) {
          ...
          for (Object k : javaObject.keySet()) {
            ...
            int errCode =
                PyDict_SetItem(
                    pyDict, pyKey.getNativePythonObject(), pyVal.getNativePythonObject());
            if (errCode != 0) {
              String keyStr = pyKey.toString();
              pyKey.del();
              pyVal.del();
              throw new PythonException(
                  "Unable to create python dictionary. Unhashable key: " + keyStr);
            }
            pyKey.del();
            pyVal.del();
          }
  ...
  public static final PythonType<byte[]> BYTES =
      new PythonType<byte[]>("bytes", byte[].class) {
        @Override
        ...
        public byte[] adapt(Object javaObject) {
          ...
          throw new PythonException(
              "Cannot cast object of type " + javaObject.getClass().getName() + " to byte[]");
        }
      };
}
