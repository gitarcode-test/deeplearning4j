...
@Data
@AllArgsConstructor
public class ArrowWritableRecordTimeSeriesBatch extends AbstractTimeSeriesWritableRecordBatch
   ...
   */
  public ArrowWritableRecordTimeSeriesBatch(
      List<FieldVector> list, Schema schema, int timeSeriesStride) {
    this.list = list;
    this.schema = schema;
  ...
  public List<List<Writable>> get(int i) {
    ArrowWritableRecordBatch ret =
        new ArrowWritableRecordBatch(list, schema, i, timeSeriesStride / schema.numColumns());
    return ret;
  }
