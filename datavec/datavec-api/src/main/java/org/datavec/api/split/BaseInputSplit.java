...
public abstract class BaseInputSplit implements InputSplit {
  ...
  protected List<String>
      uriStrings; // URIs, as a String, via toString() method (which includes file:/ etc)
  ...
  /**
   * Samples the locations based on the PathFilter and splits the result into an array of InputSplit
   * objects, with sizes proportional to the weights.
   *
