...
public class IntegerColumnCondition extends BaseColumnCondition {
   ...
   * @param value Value to use in the condition
   */
  public IntegerColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, int value) {
  ...
  private IntegerColumnCondition(
  ...
  public String toString() {
    return "IntegerColumnCondition(columnName=\""
        + columnName
        + "\","
        + op
        + ","
