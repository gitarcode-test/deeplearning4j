...
public class ConcatenateStringColumns extends BaseTransform implements ColumnOp {
   ...
   */
  public ConcatenateStringColumns(
      String newColumnName, String delimiter, String... columnsToConcatenate) {
  ...
  public List<Writable> map(List<Writable> writables) {
    ...
    for (String columnName : columnsToConcatenate) {
      if (i++ > 0) newColumnText.append(delimiter);
  ...
  public String toString() {
    return "ConcatenateStringColumns(delimiters="
        + delimiter
        + " columnsToConcatenate="
        + columnsToConcatenate
        + ")";
  }
