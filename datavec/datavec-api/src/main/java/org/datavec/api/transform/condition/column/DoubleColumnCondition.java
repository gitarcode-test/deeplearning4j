...
public class DoubleColumnCondition extends BaseColumnCondition {
  ...
  /**
   * Constructor for operations such as less than, equal to, greater than, etc. Uses default
   * sequence condition mode, {@link BaseColumnCondition#DEFAULT_SEQUENCE_CONDITION_MODE}
   *
   ...
   * @param value Value to use in the condition
   */
  public DoubleColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, double value) {
   ...
   */
  public DoubleColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, Set<Double> set) {
    super(column, sequenceConditionMode);
    if (op != ConditionOp.InSet && op != ConditionOp.NotInSet) {
      throw new IllegalArgumentException(
  ...
  private DoubleColumnCondition(
      @JsonProperty("columnName") String columnName,
      @JsonProperty("op") ConditionOp op,
      @JsonProperty("value") double value,
      @JsonProperty("set") Set<Double> set) {
  ...
  public String toString() {
    return "DoubleColumnCondition(columnName=\""
        + columnName
        + "\","
        + op
        + ","
