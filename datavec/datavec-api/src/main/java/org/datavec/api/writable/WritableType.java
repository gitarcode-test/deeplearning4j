...
public enum WritableType {
  ...
  // New writables can be added to the end of the list, but not between exiting types, as this will
  // change the
  // ordinal value for all writable types that follow, which will mess up serialization in some
  // cases (like Spark
  ...
  /**
   * Return the class of the implementation corresponding to each WritableType. Note that if {@link
   * #isCoreWritable()} returns false, null will be returned by this method.
   *
