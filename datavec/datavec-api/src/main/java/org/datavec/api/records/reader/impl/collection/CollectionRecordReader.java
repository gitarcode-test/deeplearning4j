...
public class CollectionRecordReader extends BaseRecordReader {
  ...
  public Record nextRecord() {
    return new org.datavec.api.records.impl.Record(
        next(), new RecordMetaDataIndex(count - 1, null, CollectionRecordReader.class));
  }
  ...
  public List<Record> loadFromMetaData(List<RecordMetaData> recordMetaDatas) throws IOException {
    ...
    if (original instanceof List) {
      ...
      for (Integer i : toLoad) {
        ...
        Record r =
            new org.datavec.api.records.impl.Record(
                l, new RecordMetaDataIndex(i, null, CollectionRecordReader.class));
        out.add(r);
      }
    } else {
      ...
      while (iter.hasNext()) {
        ...
        Record r =
            new org.datavec.api.records.impl.Record(
                l, new RecordMetaDataIndex(i - 1, null, CollectionRecordReader.class));
        out.add(r);
      }
    }
    return out;
