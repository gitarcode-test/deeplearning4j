...
public class FloatColumnCondition extends BaseColumnCondition {
   ...
   * @param value Value to use in the condition
   */
  public FloatColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, float value) {
   ...
   */
  public FloatColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, Set<Float> set) {
    super(column, sequenceConditionMode);
    if (op != ConditionOp.InSet && op != ConditionOp.NotInSet) {
      throw new IllegalArgumentException(
  ...
  private FloatColumnCondition(
      @JsonProperty("columnName") String columnName,
      @JsonProperty("op") ConditionOp op,
      @JsonProperty("value") float value,
      @JsonProperty("set") Set<Float> set) {
  ...
  public String toString() {
    return "FloatColumnCondition(columnName=\""
        + columnName
        + "\","
        + op
        + ","
