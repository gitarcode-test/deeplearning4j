...
public class StringMetaData extends BaseColumnMetaData {
  ...
  /**
   * @param mustMatchRegex Nullable. If not null: this is a regex that each string must match in
   *     order for the entry to be considered valid.
  ...
  public StringMetaData(
      ...
      @JsonProperty("regex") String mustMatchRegex,
