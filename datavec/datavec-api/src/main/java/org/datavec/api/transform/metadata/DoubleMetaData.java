...
public class DoubleMetaData extends BaseColumnMetaData {
  ...
  // minAllowedValue/maxAllowedValue are nullable: null -> no restriction on
  // minAllowedValue/maxAllowedValue values
  ...
  /**
   * @param minAllowedValue Min allowed value. If null: no restriction on minAllowedValue value in
   *     this column
   * @param maxAllowedValue Max allowed value. If null: no restriction on maxAllowedValue value in
   *     this column
   */
  public DoubleMetaData(
      @JsonProperty("name") String name,
      @JsonProperty("minAllowedValue") Double minAllowedValue,
   ...
   */
  public DoubleMetaData(
      String name, Double min, Double maxAllowedValue, boolean allowNaN, boolean allowInfinite) {
    super(name);
