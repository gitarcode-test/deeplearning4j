...
public class StringColumnCondition extends BaseColumnCondition {
   ...
   * @param value Value to use in the condition
   */
  public StringColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, String value) {
   ...
   */
  public StringColumnCondition(
      String column, SequenceConditionMode sequenceConditionMode, ConditionOp op, Set<String> set) {
    super(column, sequenceConditionMode);
  ...
  public String toString() {
    return "StringColumnCondition(columnName=\""
        + columnName
        + "\","
        + op
        + ","
