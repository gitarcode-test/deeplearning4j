 ...
 * @author Adam Gibson
 */
public class CudaUtf32Buffer extends BaseCudaDataBuffer {
     ...
     */
    public CudaUtf32Buffer(Pointer pointer, Indexer indexer, long length) {
        super(pointer, indexer, length);
    }

    public CudaUtf32Buffer(ByteBuffer buffer, DataType dataType, long length, long offset) {
        super(buffer, dataType, length, offset);
    }

    public CudaUtf32Buffer(long length) {
        super(length);
    }
    ...
    public CudaUtf32Buffer(long length, boolean initialize, MemoryWorkspace workspace) {
    ...
    protected DataBuffer create(long length) {
        return new CudaUtf32Buffer(length);
    }
