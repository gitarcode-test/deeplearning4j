...
/**
 * This class describes top-level allocation unit. Every buffer passed into CUDA wii have allocation
 * point entry, describing allocation state.
 *
...
public class AllocationPoint {
  ...
  @Getter private OpaqueDataBuffer ptrDataBuffer;

  @Getter @Setter private Long objectId;

  @Getter @Setter private Long bucketId;

  @Getter @Setter private boolean isAttached = false;

  @Getter @Setter private volatile boolean released = false;
  ...
  */
  ...
  public void setPointers(Pointer primary, Pointer special, long numberOfElements) {
    NativeOpsHolder.getInstance()
        .getDeviceNativeOps()
        .dbSetPrimaryBuffer(ptrDataBuffer, primary, numberOfElements);
    NativeOpsHolder.getInstance()
        .getDeviceNativeOps()
        .dbSetSpecialBuffer(ptrDataBuffer, special, numberOfElements);
  }
  ...
  */
   ...
   *
   * <p>PLEASE NOTE: Return value CAN be null
   *
   * @return
   */
  ...
  /**
   * This method returns CUDA pointer object for this allocation. It can be either device pointer or
   * pinned memory pointer, or null.
   *
   * @return
   */
