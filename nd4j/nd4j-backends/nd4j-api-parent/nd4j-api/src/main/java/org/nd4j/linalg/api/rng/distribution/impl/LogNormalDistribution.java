...
public class LogNormalDistribution extends BaseDistribution {
  ...
  public LogNormalDistribution(Random rng, double mean, double sd)
   ...
   * @since 2.1
   */
  public LogNormalDistribution(double mean, double sd, double inverseCumAccuracy)
      throws NotStrictlyPositiveException {
  ...
  public INDArray sample(INDArray ret) {
    if (means != null) {
      return Nd4j.getExecutioner()
          .exec(
              new org.nd4j.linalg.api.ops.random.impl.LogNormalDistribution(
