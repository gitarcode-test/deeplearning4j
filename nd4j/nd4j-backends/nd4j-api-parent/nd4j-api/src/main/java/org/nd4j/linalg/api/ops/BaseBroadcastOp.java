...
public abstract class BaseBroadcastOp extends BaseOp implements BroadcastOp {
  ...
  public BaseBroadcastOp(SameDiff sameDiff, SDVariable i_v1, SDVariable i_v2, long[] dimension) {
  ...
  public BaseBroadcastOp(SameDiff sameDiff, SDVariable i_v, long[] dimension, Object[] extraArgs) {
  ...
  public List<LongShapeDescriptor> calculateOutputShape() {
    ...
    return Collections.singletonList(
        LongShapeDescriptor.fromShape(
            Shape.broadcastOutputShape(shapeX, shapeY),
