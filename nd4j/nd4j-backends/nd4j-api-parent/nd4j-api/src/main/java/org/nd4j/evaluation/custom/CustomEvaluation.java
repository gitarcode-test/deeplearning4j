...
public class CustomEvaluation<T> extends BaseEvaluation<CustomEvaluation> {
  ...
  public static class Metric<T> implements IMetric {
    ...
    @Getter @NonNull private ResultLambda<T> getResult;
  ...
  public double getValue(IMetric metric) {
    ...
    } else throw new IllegalStateException("Can't get value for non-regression Metric " + metric);
  }
