...
public class VGG16ImagePreProcessor implements DataNormalization {
  ...
  public static final INDArray VGG_MEAN_OFFSET_BGR =
      Nd4j.create(new double[] {103.939, 116.779, 123.68});
  public static final INDArray VGG_MEAN_OFFSET_BGR_FLOAT =
      VGG_MEAN_OFFSET_BGR.castTo(DataType.FLOAT);
  public static final INDArray VGG_MEAN_OFFSET_BGR_FLOAT16 =
      VGG_MEAN_OFFSET_BGR.castTo(DataType.HALF);
  ...
  public void fitLabel(boolean fitLabels) {
    if (fitLabels) {
      log.warn(
          "Labels fitting not currently supported for ImagePreProcessingScaler. Labels will not be"
              + " modified");
    }
  }
    ...
    switch (features.dataType()) {
      ...
      default:
        throw new UnsupportedOperationException(
            "Cannot preprocess features in non-floating point datatype: " + features.dataType());
    }
  }
}
