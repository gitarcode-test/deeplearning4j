...
public abstract class BaseReduceFloatOp extends BaseReduceOp implements ReduceFloatOp {
  ...
  public BaseReduceFloatOp(
      INDArray x, INDArray y, INDArray z, boolean keepDims, long... dimensions) {
  ...
  protected BaseReduceFloatOp(
      SameDiff sameDiff, SDVariable i_v, SDVariable i_v2, long[] dimensions) {
  ...
  protected BaseReduceFloatOp(
      SameDiff sameDiff, SDVariable i_v, boolean keepDims, SDVariable dimensions) {
    super(sameDiff, i_v, dimensions, keepDims);
  }
  ...
  protected BaseReduceFloatOp(
      SameDiff sameDiff, SDVariable input, SDVariable dimensions, boolean keepDims) {
    super(sameDiff, input, dimensions, keepDims);
  }
  ...
  public List<LongShapeDescriptor> calculateOutputShape(OpContext oc) {
    ...
    if (!retType.isFPType()) retType = Nd4j.defaultFloatingPointType();
  ...
  public List<DataType> calculateOutputDataTypes(List<DataType> dataTypes) {
    ...
    Preconditions.checkState(
        ...
        "Expected 1 or 2 input datatype for %s, got input %s",
        getClass(),
        dataTypes);
    Preconditions.checkState(
