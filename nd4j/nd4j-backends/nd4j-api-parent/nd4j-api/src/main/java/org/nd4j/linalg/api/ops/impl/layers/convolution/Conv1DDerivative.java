...
public class Conv1DDerivative extends DynamicCustomOp {
  ...
  public Conv1DDerivative(
      @NonNull SameDiff sameDiff, @NonNull SDVariable[] inputs, @NonNull Conv1DConfig config) {
  ...
  public List<DataType> calculateOutputDataTypes(List<DataType> inputDataTypes) {
    ...
    return new ArrayList<>(
        inputDataTypes.subList(0, inputDataTypes.size() - 1)); // All except gradient input variable
  }
}
