...
public class ActivationGradientCheckListener extends BaseListener {
  ...
  @Getter @Setter private String variableName;
  @Getter @Setter private long[] idx;
  @Getter @Setter private double eps;
  ...
  public void opExecution(
    ...
    Preconditions.checkState(
        variableName != null,
        "No variable name has been set yet. Variable name must be set before using this listener");
