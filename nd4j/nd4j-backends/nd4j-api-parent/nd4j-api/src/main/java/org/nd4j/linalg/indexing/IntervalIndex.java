...
/**
 * And indexing representing an interval. An interval over a given dimension will create a view
 * similar to a {@link PointIndex} starting from a position and ending at one.
 *
...
public class IntervalIndex implements INDArrayIndex {
  ...
  @Getter protected boolean inclusive;
  ...
  public void init(INDArray arr, long begin, int dimension) {
    ...
    Preconditions.checkState(
        endInc < arr.size(dimension),
        "Invalid interval: %s on array with shape %ndShape",
        this,
        arr);
  }
