...
public class DepthwiseConv2D extends DynamicCustomOp {
  ...
  public DepthwiseConv2D(
      INDArray layerInput, INDArray depthWeights, INDArray bias, Conv2DConfig config) {
  ...
  public Map<String, Map<String, AttributeAdapter>> attributeAdaptersForFunction() {
    ...
    tfMappings.put(
        "sH",
        new ConditionalFieldValueIntIndexArrayAdapter("NCHW", 2, 1, fields.get("dataFormat")));
    tfMappings.put(
        "sW",
        new ConditionalFieldValueIntIndexArrayAdapter("NCHW", 3, 2, fields.get("dataFormat")));
    tfMappings.put(
        "dH",
        new ConditionalFieldValueIntIndexArrayAdapter("NCHW", 2, 1, fields.get("dataFormat")));
    tfMappings.put(
  ...
  public List<SDVariable> doDiff(List<SDVariable> f1) {
    ...
    return Arrays.asList(
        new DepthwiseConv2DBp(sameDiff, arg(0), arg(1), bias, f1.get(0), this.config)
            .outputVariables());
  }
