...
public class SDValidation {
    ...
    if (v.dataType() == DataType.BOOL || v.dataType() == DataType.UTF8)
      throw new IllegalStateException(
          "Input \""
              ...
              + "\" for operation \""
              + opName
              + "\" must be an numerical type type; got variable \""
              + v.name()
              + "\" with non-integer data type "
              + v.dataType());
  }
    ...
    if (!v.dataType().isIntType())
      throw new IllegalStateException(
          "Input \""
              ...
              + "\" for operation \""
              + opName
              + "\" must be an integer type; got variable \""
              + v.name()
              + "\" with non-integer data type "
              + v.dataType());
  }
    ...
    if (!v.dataType().isFPType())
      throw new IllegalStateException(
          "Cannot apply operation \""
              ...
              + "\" to variable \""
              + v.name()
              + "\" with non-floating point data type "
              + v.dataType());
  }
    ...
    if (!v.dataType().isFPType())
      throw new IllegalStateException(
          "Input \""
              ...
              + "\" for operation \""
              + opName
              + "\" must be an floating point type; got variable \""
              + v.name()
              + "\" with non-floating point data type "
              + v.dataType());
  }
    ...
    if (v.dataType() != DataType.BOOL)
      throw new IllegalStateException(
          "Input \""
              ...
              + "\" for operation \""
              + opName
              + "\" must be an boolean variable; got variable \""
              + v.name()
    ...
    if (v1.dataType() != DataType.BOOL || v2.dataType() != DataType.BOOL)
      throw new IllegalStateException(
          "Cannot perform operation \""
              ...
              + "\" and \""
              + v2.name()
              + "\" if one or both variables are non-boolean: "
              + v1.dataType()
              + " and "
              + v2.dataType());
  }
   ...
   * optionally be restricted to numerical SDVariables only (not boolean or utf8))
   *
   * @param opName Operation name to print in the exception
      ...
      for (int i = 1; i < vars.length; i++) {
        if (first != vars[i].dataType()) {
          ...
          throw new IllegalStateException(
              "Cannot perform operation \""
                  + opName
                  + "\" to variables with different datatypes:"
                  + " Variable names "
