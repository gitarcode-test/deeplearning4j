...
public class BooleanIndexing {
   ...
   * @return true if all of the elements meet the specified condition false otherwise
   */
  ...
  /**
   * This method does element-wise comparison for 2 equal-sized matrices, for each element that
   * matches Condition. To is the array to apply the indexing to from is a condition mask array (0
   * or 1). This would come from the output of a bit masking method like: {@link
   * INDArray#gt(Number)},{@link INDArray#gte(Number)}, {@link INDArray#lt(Number)},..
   *
  ...
  public static void assignIf(
      @NonNull INDArray to, @NonNull INDArray from, @NonNull Condition condition) {
    if (!(condition instanceof BaseCondition))
      throw new UnsupportedOperationException("Only static Conditions are supported");
   ...
   * @param condition
   */
  public static void replaceWhere(
      @NonNull INDArray to, @NonNull INDArray from, @NonNull Condition condition) {
    if (!(condition instanceof BaseCondition))
      throw new UnsupportedOperationException("Only static Conditions are supported");
  ...
  /**
   * Choose from the inputs based on the given condition. This returns a row vector of all elements
   * fulfilling the condition listed within the array for input
   *
   * @param input the input to filter
   * @param condition the condition to filter based on
   * @return a row vector of the input elements that are true ffor the given conditions
   */
  ...
  /**
   * Choose from the inputs based on the given condition. This returns a row vector of all elements
   * fulfilling the condition listed within the array for input. The double and integer arguments
   * are only relevant for scalar operations (like when you have a scalar you are trying to compare
   * each element in your input against)
   *
   * @param input the input to filter
   ...
   * @return a row vector of the input elements that are true ffor the given conditions
   */
  public static INDArray chooseFrom(
  ...
  /**
   * This method does element-wise assessing for 2 equal-sized matrices, for each element that
   * matches Condition
   *
   * @param to
   * @param set
   ...
   */
  public static void replaceWhere(
      @NonNull INDArray to, @NonNull Number set, @NonNull Condition condition) {
    if (!(condition instanceof BaseCondition))
      throw new UnsupportedOperationException("Only static Conditions are supported");
   ...
   *
   * <p>PLEASE NOTE: This method will return -1 value if condition wasn't met
   *
   * @param array
   * @param condition
   * @return
   ...
   *
   * <p>PLEASE NOTE: This method will return -1 values for missing conditions
   *
   * @param array
   * @param condition
   * @param dimension
