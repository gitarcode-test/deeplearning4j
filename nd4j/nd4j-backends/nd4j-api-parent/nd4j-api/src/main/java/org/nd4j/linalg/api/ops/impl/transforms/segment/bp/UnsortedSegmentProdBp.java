...
public class UnsortedSegmentProdBp extends DynamicCustomOp {

    private int numSegments;

    public UnsortedSegmentProdBp(SameDiff sameDiff, SDVariable data, SDVariable segmentIds, SDVariable gradient, int numSegments) {
        super(null, sameDiff,  new SDVariable[] {data, segmentIds, gradient}, false);
        this.numSegments = numSegments;
        addIArgument(numSegments);
    }

    public UnsortedSegmentProdBp(){ }
