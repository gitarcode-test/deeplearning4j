...
public class ArrayDescriptor {
  ...
  public int hashCode() {
    if (intArray != null) {
      ...
      return floatArray.getClass().hashCode()
          + 31 * Arrays.hashCode(floatArray)
          + 31 * dtype.ordinal();
    } else if (boolArray != null) {
      return boolArray.getClass().hashCode()
          + 31 * Arrays.hashCode(boolArray)
          + 31 * dtype.ordinal();
    } else if (doubleArray != null) {
      return doubleArray.getClass().hashCode()
          + 31 * Arrays.hashCode(doubleArray)
          + 31 * dtype.ordinal();
    } else if (longArray != null) {
      return longArray.getClass().hashCode()
          + 31 * Arrays.hashCode(longArray)
          + 31 * dtype.ordinal();
    } else {
      return 0;
    }
