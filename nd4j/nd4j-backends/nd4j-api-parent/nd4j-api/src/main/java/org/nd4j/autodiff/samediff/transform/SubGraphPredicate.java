...
public class SubGraphPredicate extends OpPredicate {
  ...
  protected Map<Integer, OpPredicate> opInputMatchPredicates =
      new HashMap<>(); // Must match - but these are NOT included in the resultant subgraph
  protected Map<Integer, OpPredicate> opInputSubgraphPredicates =
      new HashMap<>(); // Must match - and thare ARE incrluded in the resultant subgraph
   ...
   * i.e., the subgraph matches if the input matches the predicate, but when returning the SubGraph
   * itself, the function for this input is not added to the SubGraph
   *
   ...
   * i.e., the subgraph matches if the input matches the predicate, and when returning the SubGraph
   * itself, the function for this input IS added to the SubGraph
   *
   * @param inputNum Input number
   * @param opPredicate Predicate that the input must match
   * @return This predicate with the additional requirement added
