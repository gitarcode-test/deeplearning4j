...
public interface ArrayRegistry {
  ...
  /**
   * Returns all arrays registered with this registry
   *
   * @return
   */
  ...
  /**
   * Returns the array with the given id or null if it doesn't exist
   *
   * @param id the id of the array to get
   * @return the array with the given id or null if it doesn't exist
   */
  INDArray lookup(long id);

  /**
   * Returns true if the given array is registered with this registry
   *
   * @param array the array to check
   * @return true if the given array is registered with this registry
   */
