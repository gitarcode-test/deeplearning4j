...
public final class FlatConfiguration extends Table {
  ...
  public static FlatConfiguration getRootAsFlatConfiguration(ByteBuffer _bb) {
    return getRootAsFlatConfiguration(_bb, new FlatConfiguration());
  }

  public static FlatConfiguration getRootAsFlatConfiguration(
      ByteBuffer _bb, FlatConfiguration obj) {
  ...
  public FlatConfiguration __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static int createFlatConfiguration(
  ...
  public static void startFlatConfiguration(FlatBufferBuilder builder) {
    builder.startTable(8);
  }
  ...
  public static void addExecutionMode(FlatBufferBuilder builder, byte executionMode) {
    builder.addByte(1, executionMode, 0);
  }

  public static void addProfilingMode(FlatBufferBuilder builder, byte profilingMode) {
    builder.addByte(2, profilingMode, 0);
  }

  public static void addOutputMode(FlatBufferBuilder builder, byte outputMode) {
    builder.addByte(3, outputMode, 0);
  }

  public static void addTimestats(FlatBufferBuilder builder, boolean timestats) {
    builder.addBoolean(4, timestats, false);
  }

  public static void addFootprintForward(FlatBufferBuilder builder, long footprintForward) {
  ...
  public static void finishFlatConfigurationBuffer(FlatBufferBuilder builder, int offset) {
    builder.finish(offset);
  }

  public static void finishSizePrefixedFlatConfigurationBuffer(
  ...
  public static final class Vector extends BaseVector {
    ...
    public FlatConfiguration get(int j) {
      return get(new FlatConfiguration(), j);
    }

    public FlatConfiguration get(FlatConfiguration obj, int j) {
