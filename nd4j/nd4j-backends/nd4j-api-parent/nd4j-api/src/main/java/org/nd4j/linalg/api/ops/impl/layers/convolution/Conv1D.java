...
public class Conv1D extends DynamicCustomOp {
  ...
  private static final String INVALID_CONFIGURATION =
      "Invalid Conv1D configuration : s = %s p = %s ";
  ...
  protected void addArgs() {
    if (config == null) config = Conv1DConfig.builder().build();
  ...
  public List<SDVariable> doDiff(List<SDVariable> grads) {
    ...
    Conv1DDerivative gradFn =
        new Conv1DDerivative(sameDiff, args.toArray(new SDVariable[0]), config);
