...
public class MiniBatchFileDataSetIterator implements DataSetIterator {
   ...
   * @throws IOException
   */
  public MiniBatchFileDataSetIterator(DataSet baseData, int batchSize, boolean delete)
      throws IOException {
  ...
  private DataSet read(int idx) throws IOException {
    ...
    BufferedInputStream labelInputStream =
        new BufferedInputStream(new FileInputStream(paths.get(idx)[1]));
  ...
  private String[] writeData(DataSet write) throws IOException {
    ...
    BufferedOutputStream dataOutLabels =
        new BufferedOutputStream(
            new FileOutputStream(new File(rootDir, dataSetId + ".labels.bin")));
