...
public class AdaBelief implements IUpdater {
  ...
  private double beta1 = DEFAULT_BETA1_MEAN_DECAY; // gradient moving avg decay rate

  @lombok.Builder.Default
  private double beta2 = DEFAULT_BETA2_VAR_DECAY; // gradient sqrt decay rate

  @lombok.Builder.Default private double epsilon = DEFAULT_EPSILON;

  public AdaBelief() {
    this(DEFAULT_LEARNING_RATE, DEFAULT_BETA1_MEAN_DECAY, DEFAULT_BETA2_VAR_DECAY, DEFAULT_EPSILON);
  }
