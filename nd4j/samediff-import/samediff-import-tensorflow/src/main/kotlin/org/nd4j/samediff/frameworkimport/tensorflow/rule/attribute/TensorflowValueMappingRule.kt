...
@MappingRule("tensorflow", "valuemapping", "attribute")
class TensorflowValueMappingRule(
    mappingNamesToPerform: Map<String, String>,
    transformerArgs: Map<String, List<OpNamespace.ArgDescriptor>>
) :
    ValueMapping<GraphDef, OpDef, NodeDef, OpDef.AttrDef, AttrValue, TensorProto, DataType>(
