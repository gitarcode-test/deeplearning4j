...
>(
    ...
    override fun outputsType(argDescriptorType: List<OpNamespace.ArgDescriptor.ArgType>): Boolean {
        return !argDescriptorType.containsAll(
            listOf(
        ...
        for ((k, v) in mappingNamesToPerform()) {
            ...
            when (irAttribute.attributeValueType()) {
                ...
                AttributeValueType.FLOAT -> {
                    ...
                    // DO NOT REMOVE work around for numerical underflow that happens at the JVM
                    // level, this does a safe cast allowing us to get the real value out
                ...
                AttributeValueType.DATA_TYPE -> {
                    ...
                    descriptorBuilder.dataTypeValue =
                        irAttribute.dataTataTypeValue().nameSpaceDataType()
                    descriptorBuilder.argIndex =
                        lookupIndexForArgDescriptor(
                            argDescriptorName = k,
                            opDescriptorName = mappingCtx.nd4jOpName(),
                    ...
                    throw IllegalArgumentException(
                        "Unable to map value $k for op name ${mappingCtx.opName() }. Please use different rule for list values and tensors."
                    )
                }
            }
