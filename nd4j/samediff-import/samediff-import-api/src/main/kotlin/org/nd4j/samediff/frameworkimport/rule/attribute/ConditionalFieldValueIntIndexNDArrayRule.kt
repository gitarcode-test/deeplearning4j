...
>(
    ...
    BaseAttributeExtractionRule<
        ...
        DATA_TYPE
    >(
        name = "conditionalfieldvalueintindexndarray",
    ...
    override fun convertAttributes(
        ...
        for ((k, v) in mappingNamesToPerform()) {
            ...
            val inputArr =
                mappingCtx.tensorInputFor(listOfArgs!![3].stringValue).toNd4jNDArray().ravel()
            ...
            val intValueToSet =
                if (testValue == targetValueToTest) inputArr.getInt(trueIndex)
                else inputArr.getInt(falseIndex)
            ret.add(
                ArgDescriptor {
                    name = v
