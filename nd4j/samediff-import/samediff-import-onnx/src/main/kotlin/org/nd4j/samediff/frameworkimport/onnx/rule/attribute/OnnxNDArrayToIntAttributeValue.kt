...
@MappingRule("onnx", "ndarraytointattributevalue", "attribute")
class OnnxNDArrayToIntAttributeValue(mappingNamesToPerform: Map<String, String>) :
    ...
    >(mappingNamesToPerform = mappingNamesToPerform, transformerArgs = emptyMap()) {
