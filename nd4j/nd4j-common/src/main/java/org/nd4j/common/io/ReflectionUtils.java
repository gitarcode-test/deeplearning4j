...
public abstract class ReflectionUtils {
  ...
  public static Field findField(Class<?> clazz, String name, Class<?> type) {
    ...
    Assert.isTrue(
        name != null || type != null, "Either name or opType of the field must be specified");
  ...
  public static void doWithMethods(
      Class<?> clazz, ReflectionUtils.MethodCallback mc, ReflectionUtils.MethodFilter mf)
      throws IllegalArgumentException {
  ...
  public static void doWithFields(
      Class<?> clazz, ReflectionUtils.FieldCallback fc, ReflectionUtils.FieldFilter ff)
      throws IllegalArgumentException {
   ...
   *
   * <p>Provided class must have a public constructor.
   *
  ...
  public static <T> T newInstance(Class<T> clazz, Object... args) {
    ...
    try {
      ...
      if (!Modifier.isPublic(constructor.getModifiers())) {
        throw new IllegalArgumentException(
            String.format(
                "Class [%s] must have public constructor in order to be instantiated.",
                clazz.getName()));
      }
