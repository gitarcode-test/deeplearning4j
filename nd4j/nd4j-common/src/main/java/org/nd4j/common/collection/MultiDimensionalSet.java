...
public class MultiDimensionalSet<K, V> implements Set<Pair<K, V>> {
  ...
  /**
   * Returns <tt>true</tt> if this applyTransformToDestination contains the specified element. More
   * formally, returns <tt>true</tt> if and only if this applyTransformToDestination contains an
   ...
   *     applyTransformToDestination (<a href="Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified element is null and this
   *     applyTransformToDestination does not permit null elements (<a
  ...
  /**
   * Returns an array containing all of the elements in this applyTransformToDestination. If this
   * applyTransformToDestination makes any guarantees as to what order its elements are returned by
   ...
   * applyTransformToDestination. (In other words, this method must allocate a new array even if
   * this applyTransformToDestination is backed by an array). The caller is thus free to modify the
   * returned array.
   *
   * <p>
   *
   ...
   * applyTransformToDestination fits in the specified array, it is returned therein. Otherwise, a
   * new array is allocated with the runtime type of the specified array and the size of this
   * applyTransformToDestination.
   *
   * <p>
   *
   * <p>If this applyTransformToDestination fits in the specified array with room to spare (i.e.,
   * the array has more elements than this applyTransformToDestination), the element in the array
   * immediately following the end of the applyTransformToDestination is applyTransformToDestination
   * to <tt>null</tt>. (This is useful in determining the length of this applyTransformToDestination
   * <i>only</i> if the caller knows that this applyTransformToDestination does not contain any null
   * elements.)
   *
   * <p>
   *
   * <p>If this applyTransformToDestination makes any guarantees as to what order its elements are
   ...
   * <p>
   *
   * <p>Suppose <tt>x</tt> is a applyTransformToDestination known to contain only strings. The
   * following code can be used to dump the applyTransformToDestination into a newly allocated array
   * of <tt>String</tt>:
   *
   * <p>
   *
   ...
   *     stored, if it is big enough; otherwise, a new array of the same runtime type is allocated
   *     for this purpose.
   * @return an array containing all the elements in this applyTransformToDestination
   * @throws ArrayStoreException if the runtime type of the specified array is not a supertype of
   *     the runtime type of every element in this applyTransformToDestination
   ...
   * (optional operation). More formally, adds the specified element <tt>e</tt> to this
   * applyTransformToDestination if the applyTransformToDestination contains no element <tt>e2</tt>
   * such that <tt>(e==null&nbsp;?&nbsp;e2==null&nbsp;:&nbsp;e.equals(e2))</tt>. If this
   * applyTransformToDestination already contains the element, the call leaves the
   * applyTransformToDestination unchanged and returns <tt>false</tt>. In combination with the
   * restriction on constructors, this ensures that sets never contain duplicate elements.
   *
   * <p>
   *
   * <p>The stipulation above does not imply that sets must accept all elements; sets may refuse to
   * add any particular element, including <tt>null</tt>, and throw an exception, as described in
   * the specification for {@link Collection#add Collection.add}. Individual
   * applyTransformToDestination implementations should clearly document any restrictions on the
   ...
   *     to this applyTransformToDestination
   * @throws NullPointerException if the specified element is null and this
   *     applyTransformToDestination does not permit null elements
   * @throws IllegalArgumentException if some property of the specified element prevents it from
   *     being added to this applyTransformToDestination
   */
  @Override
  ...
  /**
   * Removes the specified element from this applyTransformToDestination if it is present (optional
   * operation). More formally, removes an element <tt>e</tt> such that
   * <tt>(o==null&nbsp;?&nbsp;e==null&nbsp;:&nbsp;o.equals(e))</tt>, if this
   * applyTransformToDestination contains such an element. Returns <tt>true</tt> if this
   * applyTransformToDestination contained the element (or equivalently, if this
   * applyTransformToDestination changed as a result of the call). (This applyTransformToDestination
   ...
   *     incompatible with this applyTransformToDestination (<a
   *     href="Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if the specified collection contains one or more null elements and
   *     this applyTransformToDestination does not permit null elements (<a
   ...
   * they're not already present (optional operation). If the specified collection is also a
   * applyTransformToDestination, the <tt>addAll</tt> operation effectively modifies this
   * applyTransformToDestination so that its value is the <i>union</i> of the two sets. The behavior
   * of this operation is undefined if the specified collection is modified while the operation is
   * in progress.
   *
   ...
   *     from being added to this applyTransformToDestination
   * @throws NullPointerException if the specified collection contains one or more null elements and
   *     this applyTransformToDestination does not permit null elements, or if the specified
   *     collection is null
   ...
   * applyTransformToDestination all of its elements that are not contained in the specified
   * collection. If the specified collection is also a applyTransformToDestination, this operation
   * effectively modifies this applyTransformToDestination so that its value is the
   ...
   * @throws ClassCastException if the class of an element of this applyTransformToDestination is
   *     incompatible with the specified collection (<a
   *     href="Collection.html#optional-restrictions">optional</a>)
   * @throws NullPointerException if this applyTransformToDestination contains a null element and
   *     the specified collection does not permit null elements (<a
   *     href="Collection.html#optional-restrictions">optional</a>), or if the specified collection
   *     is null
   * @see #remove(Object)
   */
   ...
   * specified collection (optional operation). If the specified collection is also a
   * applyTransformToDestination, this operation effectively modifies this
   * applyTransformToDestination so that its value is the <i>asymmetric applyTransformToDestination
  ...
  /**
   * Removes all of the elements from this applyTransformToDestination (optional operation). The
   * applyTransformToDestination will be empty after this call returns.
   *
